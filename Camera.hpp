...
struct Camera{
    ...
    ////below we set how if different sets of argements were passed through Camera, how will an object of Camera type set itself up

    Camera():_eyePoint(vec3(0,0,0)),_viewDir(vec3(0,0,1)),_upDir(vec3(0,1,0)), _field_of_view(60){}    //case 1: if no arguments were passed
